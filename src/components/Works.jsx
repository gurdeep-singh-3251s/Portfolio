    ...
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          ...
          <br />
          I enjoy building Scalable, User oriented, and Performant softwares.
        </motion.p>
      </div>
      <h2 className={`text-white font-black md:text-[30px]  sm:text-[40px] xs:text-[30px] text-[20px]  `}>Stuff I Made.</h2>
      <p className={styles.sectionSubText}>view my <a
          href="https://github.com/gurdeep-singh-3251s"
          target="_blank"
